...
NEGATIVE_PATH = os.path.join(TEST_AUDIO_DIR, "ff3d3feb-3371-44ad-a3b3-85969c2cd5ab.wav")
POSITIVE_PATH = os.path.join(TEST_AUDIO_DIR, "fd79e55d-d3a3-4083-aba1-4f00b545c3d6.wav")
